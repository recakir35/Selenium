...
public class Q09_ {
    public static void main(String[] args) {
        ...
        }else System.out.println("Delete Buttonu Testi FAILED");
        ...
        if (addRemoveYaziElementi.isDisplayed()){
            System.out.println("Add/Remove Yazısı Testi PASSED");
        } else System.out.println("Add/Remove Yazısı Testi FAILED");
